      ...
      <div className="card card--wide">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            {/* ── Personal Info ── */}
            <div className="field">
              <label className="field__label" htmlFor="su-fn">
                First Name
              </label>
              <input
                id="su-fn"
            ...
            <div className="field">
              <label className="field__label" htmlFor="su-ln">
                Last Name
              </label>
              <input
                id="su-ln"
            ...
            <div className="field">
              <label className="field__label" htmlFor="su-mob">
                Mobile Number
              </label>
              <input
                id="su-mob"
              ...
              <div className="addr-section">
                ...
                <div className="form-grid" style={{ marginBottom: 0 }}>
                  <div className="field full">
                    <label className="field__label" htmlFor="su-addr">
                      House / Flat / Building
                    </label>
                    <input
                      id="su-addr"
                  ...
                  <div className="field">
                    <label className="field__label" htmlFor="su-area">
                      Area / Street
                    </label>
                    <input
                      id="su-area"
                  ...
                  <div className="field">
                    <label className="field__label" htmlFor="su-lm">
                      Landmark
                    </label>
                    <input
                      id="su-lm"
                  ...
                  <div className="field">
                    <label className="field__label" htmlFor="su-city">
                      City
                    </label>
                    <input
                      id="su-city"
                  ...
                  <div className="field">
                    <label className="field__label" htmlFor="su-pin">
                      Postal Code
                    </label>
                    <input
                      id="su-pin"
